...
//thanks to https://codepen.io/mkswiss/pen/OJVWRpE for this code:
...
var framePath = "rose/"; //Define file path for your images
var highResPath = "rose/"; //if you have a downloadable high res image, define its path here.  
var nFrames = 90; //Define amount of images. counting starts at 0, to have it count to 400 you would have to ad 401 images. 
var fileType = ".png"; //Define your image file type.
var pageLengt = 5000; // this defines over what distance, in pixels, your image sequence should be displayed. esentally it defines how speady you scroll trough all the individual images. make shure your page has at least this lengt in px aswel.
